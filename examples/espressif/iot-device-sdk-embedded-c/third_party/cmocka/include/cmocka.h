...
/* Forward declaration of a IoTC Library Function that determines the current
 * time of the target platform.  This will be linked in by libiotc. */
long iotc_bsp_time_getcurrenttime_milliseconds();
