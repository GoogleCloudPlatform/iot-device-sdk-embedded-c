...
- `iotc_get_state_string` may now be used to query error strings for application debugging. See [`include/iotc_error.h`](include/iotc_error.h) to enable this feature.
